...
ปรับระบบ BookingAiLab ให้จองเครื่องได้เฉพาะวันปัจจุบัน เปิดให้บริการทุกวัน ผู้ใช้หนึ่งคนเริ่มใช้งานครั้งละ 3 ชั่วโมง และต่อเวลาได้จนมีเวลารวมสูงสุด 9 ชั่วโมงต่อวัน เฉพาะเมื่อไม่มีคิวถัดไปของเครื่องเดียวกันและยังเหลือเวลาก่อน 00:00 ครบ 3 ชั่วโมง
...
- กติกาเลือกวันและสร้างรอบจองเฉพาะวันนี้
...
1. Next.js คำนวณวันปัจจุบัน แสดงรอบจอง และให้ API ที่ตรวจสอบ Device Token และรูปแบบ request จาก WPF
...
2. ระบบสร้างรอบ 180 นาทีภายใน `openingTime` ถึง `closingTime`
3. ผู้ใช้เลือกเครื่องและรอบ จากนั้น Next.js ตรวจ policy จากข้อมูล Sheet
